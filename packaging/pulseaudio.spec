...
cp %{buildroot}%{_includedir}/pulsecore/lfe-filter.h %{buildroot}%{_includedir}/pulsecore/filter/lfe-filter.h
cp %{buildroot}%{_includedir}/pulsemodule/pulsecore/typedefs.h %{buildroot}%{_includedir}/pulsecore/typedefs.h
...
%config(noreplace) /etc/bash_completion.d/pulseaudio
#%config(noreplace) /usr/share/bash-completion/completions/pulseaudio
