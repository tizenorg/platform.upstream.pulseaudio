...
void _device_profile_set_state(dm_device_profile *profile_item,  dm_device_direction_t direction, dm_device_state_t state) {
    ...
    prev_state = profile_item->playback_state | profile_item->capture_state;
    ...
    new_state = profile_item->playback_state | profile_item->capture_state;
    pa_log_debug("new playback_state : %d, capture_state : %d => state %d", profile_item->playback_state, profile_item->capture_state, prev_state);
