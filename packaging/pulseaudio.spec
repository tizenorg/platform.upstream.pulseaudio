...
Source4:        tarball-version
Source99:       baselibs.conf
# Patches auto-generated by git-buildpackage:
Patch0:         0001-disabled-start.patch
Patch1:         0002-dsuppress-socket-error.patch
Patch2:         0003-wrong-memset.patch
...
%prep
%setup -q -T -b0
# 0001-disabled-start.patch
%patch0 -p1
# 0002-dsuppress-socket-error.patch
%patch1 -p1
# 0003-wrong-memset.patch
%patch2 -p1

%build
%autogen
export CFLAGS="%{optflags} -fno-strict-aliasing"
cp %{SOURCE4} .tarball-version
